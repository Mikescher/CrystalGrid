...
public class ReflectingWall extends ClientEntity {
	public ReflectingWall() {
		super();
	...
	public void serverCommand_added(double x, double y, byte[] data) { // After Adding;
		...
		((ClientGameLevel) super.getOwner()).getNetworkAdapter().send(NetworkGameConstants.CMD_REQRWALLINFO, ByteUtilities.long2Arr(getUID()));
	}
