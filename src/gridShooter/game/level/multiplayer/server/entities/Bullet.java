...
public class Bullet extends ServerEntity {
	...
	public Bullet(Cannon shooter) {
		...
		velocity = new MDPoint(-64, 0).rotate(Math.toRadians(shooter.getDirection() + (randFactory.nextInt(ANOMALY*2+1) - ANOMALY)), 0, 0, false);
